...
i7 i | i>= -64 && i<=63 = (fromIntegral ((i.&.0b1111111) `shiftR` 1), 0b1 .&. fromIntegral i)
i9 i | i>= -256 && i<=255 = (fromIntegral ((i.&.0b111111111) `shiftR` 4), 0b1111 .&. fromIntegral i)

i7'8, i7'16 :: Int16 -> (Word8, Word8)
i7'8 i | (i',0) <- i `quotRem` 8 = i7 i'
i7'16 i | (i',0) <- i `quotRem` 16 = i7 i'
...
asm ix st (Fneg2 _ x0 x1:asms) = br2 0b01101110 (0x7 `shiftL` 5) 0b111110 x0 x1:asm (ix+4) st asms
...
asm ix st (RetL x _:asms) = asm ix st (Ret x:asms)
...
asm ix st (SubRR _ r0 r1 r2:asms) = br3 0b11001011 0 0 r0 r1 r2:asm (ix+4) st asms
...
asm ix st (AndRR _ r0 r1 r2:asms) = br3 0b10001010 0 0 r0 r1 r2:asm (ix+4) st asms
...
asm ix st (OrRR _ r0 r1 r2:asms) = br3 0b10101010 0 0 r0 r1 r2:asm (ix+4) st asms
asm ix st (Neg _ r0 r1:asms) = [0b11001011, be r1, 0x3, 0x7 `shiftL` 5 .|. be r0]:asm (ix+4) st asms
asm ix st (MulRR _ r0 r1 r2:asms) = br3 0b10011011 0 0b11111 r0 r1 r2:asm (ix+4) st asms
asm ix st (Sdiv _ r0 r1 r2:asms) = br3 0b10011010 0b110 0b11 r0 r1 r2:asm (ix+4) st asms
...
asm ix st (AddRC _ r0 r1 i IZero:asms) = [0b10010001, fromIntegral (i `shiftR` 6), fromIntegral (0b111111 .&. i) `shiftL` 2 .|. (be r1 `shiftR` 3), lb r1 r0]:asm (ix+4) st asms
asm ix st (AddRC _ r0 r1 i Twelve:asms) = [0b10010001, 0b1 `shiftL` 6 .|. fromIntegral (i `shiftR` 6), fromIntegral (0b111111 .&. i) `shiftL` 2 .|. (be r1 `shiftR` 3), lb r1 r0]:asm (ix+4) st asms
asm ix st (SubRC _ r0 r1 i IZero:asms) = [0b11010001, fromIntegral (i `shiftR` 6), fromIntegral (0b111111 .&. i) `shiftL` 2 .|. be r1 `shiftR` 3, lb r1 r0]:asm (ix+4) st asms
asm ix st (SubRC _ r0 r1 i Twelve:asms) = [0b11010001, 0x1 `shiftL` 6 .|. fromIntegral (i `shiftR` 6), fromIntegral (0b111111 .&. i) `shiftL` 2 .|. be r1 `shiftR` 3, lb r1 r0]:asm (ix+4) st asms
asm ix st (MovRR x r0 SP:asms) = asm ix st (AddRC x r0 SP 0 IZero:asms)
...
asm ix st (AsrR _ r0 r1 r2:asms) = br3 0x9a 0x6 0b1010 r0 r1 r2:asm (ix+4) st asms
...
asm ix st (EorI _ r0 r1 (BM 1 0):asms) = [0b11010010, 0x1 `shiftL` 6, be r1 `shiftR` 3, lb r1 r0]:asm (ix+4) st asms
...
asm ix st (Fcmp _ d0 d1:asms) = [0b00011110, 0x3 `shiftL` 5 .|. be d1, 0b1000 `shiftL` 2 .|. be d0 `shiftR` 3, be d0 `shiftL` 5]:asm (ix+4) st asms
...
asm ix st (Ldr _ r (Po rb i):asms) = let (ub,lub)=i9 i in [0xf8, 0x2 `shiftL` 5 .|. ub, lub `shiftL` 4 .|. 0x1 `shiftL` 2 .|. be rb `shiftR` 3, lb rb r]:asm (ix+4) st asms
...
asm ix st (Ldp _ r0 r1 (Po rb i):asms) = let (ub,lub)=i7'8 i in [0xa8, 0x3 `shiftL` 6 .|. ub, lub `shiftL` 7 .|. be r1 `shiftL` 2 .|. be rb `shiftR` 3, lb rb r0]:asm (ix+4) st asms
...
asm ix st (Str _ r (Pr rb i):asms) = let (ub,lub)=i9 i in [0xf8, ub, lub `shiftL` 4 .|. 0x3 `shiftL` 2 .|. be rb `shiftR` 3, lb rb r]:asm (ix+4) st asms
asm ix st (Str _ r (Po rb i):asms) = let (ub,lub)=i9 i in [0xf8, ub, lub `shiftL` 4 .|. 0x1 `shiftL` 2 .|. be rb `shiftR` 3, lb rb r]:asm (ix+4) st asms
...
asm ix st (StrD _ d (Pr rb i):asms) = let (ub,lub)=i9 i in [0xfc, ub, lub `shiftL` 4 .|. 0x3 `shiftL` 2 .|. be rb `shiftR` 3, lb rb d]:asm (ix+4) st asms
asm ix st (StrD _ d (Po rb i):asms) = let (ub,lub)=i9 i in [0xfc, ub, lub `shiftL` 4 .|. 0x1 `shiftL` 2 .|. be rb `shiftR` 3, lb rb d]:asm (ix+4) st asms
...
asm ix st (Stp _ r0 r1 (Pr rb i):asms) = let (ub,lub)=i7'8 i in [0xa9, 0x2 `shiftL` 6 .|. ub, lub `shiftL` 7 .|. be r1 `shiftL` 2 .|. be rb `shiftR` 3, lb rb r0]:asm (ix+4) st asms
asm ix st (Stp _ r0 r1 (Po rb i):asms) = let (ub,lub)=i7'8 i in [0xa8, 0x2 `shiftL` 6 .|. ub, lub `shiftL` 7 .|. be r1 `shiftL` 2 .|. be rb `shiftR` 3, lb rb r0]:asm (ix+4) st asms
...
asm ix st (Stp2 _ q0 q1 (Po rb i):asms) = let (ub,lub)=i7'16 i in [0b10101100, 0x2 `shiftL` 6 .|. ub, lub `shiftL` 7 .|. be q1 `shiftL` 2 .|. be rb `shiftR` 3, lb rb q0]:asm (ix+4) st asms
asm ix st (Stp2 _ q0 q1 (Pr rb i):asms) = let (ub,lub)=i7'16 i in [0b10101101, 0x2 `shiftL` 6 .|. ub, lub `shiftL` 7 .|. be q1 `shiftL` 2 .|. be rb `shiftR` 3, lb rb q0]:asm (ix+4) st asms
...
asm ix st (StpD _ d0 d1 (Pr rb i):asms) = let (ub,lub)=i7'8 i in [0b01101101, 0x2 `shiftL` 6 .|. ub, lub `shiftL` 7 .|. be d1 `shiftL` 2 .|. be rb `shiftR` 3, lb rb d0]:asm (ix+4) st asms
...
asm ix st (LdrD _ d (Po rb i):asms) = let (ub,lub)=i9 i in [0xfc, 0x2 `shiftL` 5 .|. ub, lub `shiftL` 4 .|. 0x1 `shiftL` 2 .|. be rb `shiftR` 3, lb rb d]:asm (ix+4) st asms
...
asm ix st (LdpD _ d0 d1 (Po rb i):asms) = let (ub,lub)=i7'8 i in [0b01101100, 0x3 `shiftL` 6 .|. ub, lub `shiftL` 7 .|. be d1 `shiftL` 2 .|. be rb `shiftR` 3, lb rb d0]:asm (ix+4) st asms
...
asm ix st (StrS _ q (Pr rb i):asms) = let (ub,lub)=i9 i in [0b00111100, 0x2 `shiftL` 6 .|. ub, lub `shiftL` 4 .|. 0x3 `shiftL` 2 .|. be rb `shiftR` 3, lb rb q]:asm (ix+4) st asms
asm ix st (StrS _ q (Po rb i):asms) = let (ub,lub)=i9 i in [0b00111100, 0x2 `shiftL` 6 .|. ub, lub `shiftL` 4 .|. 0x1 `shiftL` 2 .|. be rb `shiftR` 3, lb rb q]:asm (ix+4) st asms
...
asm ix st (LdrS _ q (Po rb i):asms) = let (ub,lub)=i9 i in [0b00111100, 0x6 `shiftL` 5 .|. ub, lub `shiftL` 4 .|. 0x1 `shiftL` 2 .|. be rb `shiftR` 3, lb rb q]:asm (ix+4) st asms
...
asm ix st (Ldp2 _ q0 q1 (Po rb i):asms) = let (ub,lub)=i7'16 i in [0b10101100, 0x3 `shiftL` 6 .|. ub, lub `shiftL` 7 .|. be q1 `shiftL` 2 .|. be rb `shiftR` 3, lb rb q0]:asm (ix+4) st asms
