...
apple_compile :: IntPtr -> IntPtr -> IntPtr -> IntPtr -> IntPtr -> CString -> Ptr CSize -> Ptr (Ptr Word64) -> IO (Ptr Word8)
apple_compile (IntPtr m) (IntPtr f) (IntPtr e) (IntPtr l) (IntPtr p) src szPtr sPtr = do
    bSrc <- BS.unsafePackCString src
    (sz, fp, aa) <- cfp ((m,f), (e,l,p)) (BSL.fromStrict bSrc)
    jNull aa sPtr
    poke szPtr (fromIntegral sz) $> castFunPtrToPtr fp

foreign export ccall apple_compile :: IntPtr -> IntPtr -> IntPtr -> IntPtr -> IntPtr -> CString -> Ptr CSize -> Ptr (Ptr Word64) -> IO (Ptr Word8)
