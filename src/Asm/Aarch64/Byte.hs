...
asm ix st (Fmadd _ d0 d1 d2 d3:asms) = [0b00011111, 0x2 `shiftL` 5 .|. be d2, be d3 `shiftL` 6 .|. be d1 `shiftR` 3, lb d1 d0]:asm (ix+4) st asms
...
asm ix st (Str _ r (R rb):asms) = [0xf9, 0, be rb `shiftR` 3, lb rb r]:asm (ix+4) st asms
...
asm ix st (Str _ r (RP rb u):asms) = [0b11111000, fromIntegral (u `shiftR` 4), fromIntegral (0xf .&. u) `shiftL` 4 .|. 0x1 `shiftL` 2 .|. be rb `shiftR` 2, lb rb r]:asm (ix+4) st asms
...
asm ix st (LdpD _ d0 d1 (R rb):asms) = [0b011011000, 0x3 `shiftL` 6, be d1 `shiftL` 2 .|. be rb `shiftR` 3, lb rb d0]:asm (ix+4) st asms
