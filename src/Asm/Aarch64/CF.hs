...
uses Fmsub{}              = IS.empty
uses Fsqrt{}              = IS.empty
uses Fsqrte{}             = IS.empty
uses Faddp{}              = IS.empty
uses Fmaxp{}              = IS.empty
uses Fminp{}              = IS.empty
uses Fneg{}               = IS.empty
uses Fsqrt2{}             = IS.empty
uses Fsqrte2{}            = IS.empty
uses Fneg2{}              = IS.empty
...
defs Fmsub{}             = IS.empty
defs Fsqrt{}             = IS.empty
defs Fsqrte{}            = IS.empty
defs Fsqrt2{}            = IS.empty
defs Fsqrte2{}           = IS.empty
defs Fneg2{}             = IS.empty
defs Fneg{}              = IS.empty
defs Faddp{}             = IS.empty
defs Fmaxp{}             = IS.empty
...
defsF (Fsqrte2 _ v _)    = singleton v
...
defsF (Fsqrte _ d _)     = singleton d
...
usesF (Fsqrte2 _ _ v)      = singleton v
...
usesF (Fsqrte _ _ d)       = singleton d
