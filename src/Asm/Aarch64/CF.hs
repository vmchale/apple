...
uses (LslR _ _ r0 r1)     = fromList [r0,r1]
uses (AsrR _ _ r0 r1)     = fromList [r0,r1]
...
uses (Csneg _ _ r1 r2 _)  = fromList [r1, r2]
uses Fcsel{}              = IS.empty
...
defs (AsrR _ r _ _)      = singleton r
defs (LslR _ r _ _)      = singleton r
defs CmpRC{}             = IS.empty
defs CmpRR{}             = IS.empty
...
defs (Csneg _ r _ _ _)   = singleton r
defs Fcsel{}             = IS.empty
defs TstI{}              = IS.empty
defs Label{}             = IS.empty
defs Bc{}                = IS.empty
...
defsF (Fabs2 _ v _)      = singleton v
defsF Csel{}             = IS.empty
defsF Csneg{}            = IS.empty
defsF TstI{}             = IS.empty
...
usesF (Fcvtps _ _ r)       = singleton r
...
usesF (Fabs2 _ _ v)        = singleton v
usesF Csel{}               = IS.empty
usesF Csneg{}               = IS.empty
usesF TstI{}               = IS.empty
