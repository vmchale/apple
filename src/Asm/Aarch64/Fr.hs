...
-- Z0-Z7, P0-P3 argument/results
-- Z8-Z15, P4-P15 callee-saved
-- Z16-Z31 caller-saved

-- https://developer.arm.com/documentation/102374/0102/Procedure-Call-Standard
fromInt :: Int -> Maybe AReg
fromInt 0     = Just X0;  fromInt 1     = Just X1;  fromInt 2     = Just X2;  fromInt 3     = Just X3
fromInt 4     = Just X4;  fromInt 5     = Just X5;  fromInt 6     = Just X6;  fromInt 7     = Just X7
fromInt (-1)  = Just X8;  fromInt (-2)  = Just X9;  fromInt (-3)  = Just X10; fromInt (-4)  = Just X11
fromInt (-5)  = Just X12; fromInt (-6)  = Just X13; fromInt (-7)  = Just X14; fromInt (-8)  = Just X15
fromInt (-9)  = Just X16; fromInt (-10) = Just X17; fromInt (-11) = Just X18; fromInt _     = Nothing
...
fInt 10    = Just D0;  fInt 11    = Just D1;  fInt 12    = Just D2;  fInt 13    = Just D3
fInt 14    = Just D4;  fInt 15    = Just D5;  fInt 16    = Just D6;  fInt 17    = Just D7
fInt (-31) = Just D16; fInt (-32) = Just D17; fInt (-33) = Just D18; fInt (-34) = Just D19
fInt (-35) = Just D20; fInt (-36) = Just D21; fInt (-37) = Just D22; fInt (-38) = Just D23
fInt (-39) = Just D24; fInt (-40) = Just D25; fInt (-41) = Just D26; fInt (-42) = Just D27
fInt (-43) = Just D28; fInt (-44) = Just D29; fInt (-45) = Just D30; fInt (-46) = Just D31
fInt _     = Nothing
