...
collectS (Dup _ q _)      = ss q; collectS (Ins _ v 1 _)    = ss v
collectS (DupD _ q _ _)   = ss q; collectS (MovQQ _ q _)    = ss q
collectS (LdrS _ q _)     = ss q; collectS (ZeroS _ v)      = ss v
collectS (EorS _ v _ _)   = ss v; collectS (Fadd2 _ v _ _)  = ss v
collectS (Fsub2 _ v _ _)  = ss v; collectS (Fmul2 _ v _ _)  = ss v
collectS (Fdiv2 _ v _ _)  = ss v; collectS (Fmax2 _ v _ _)  = ss v
