...
allocReg (XorRR l r0 r1)          = sequence [XorRR () <$> useR l r0 <*> useR l r1] <* freeDone l
...
allocReg (MovqRX l r0 r1)         = sequence [MovqRX () <$> useR l r0 <*> useX l r1] <* freeDone l
allocReg (CmpRI l r i)            = sequence [CmpRI () <$> useR l r <*> pure i] <* freeDone l
allocReg (TestI l r i)            = sequence [TestI () <$> useR l r <*> pure i] <* freeDone l
...
allocReg Fsin{}                   = pure [Fsin ()]
allocReg Fninit{}                 = pure [Fninit ()]
...
allocReg (Vcmppd l r0 r1 r2 rel)   = sequence [Vcmppd () <$> useX l r0 <*> useX l r1 <*> useX l r2 <*> pure rel] <* freeDone l
