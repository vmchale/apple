...
The language is expression-oriented (immutable); there are no references. This constraint
% Let us reflect on this unexpected :

\section{Method}

Our work is based on classical liveness algorithms; we annotate statements with {\tt uses} and {\tt defs} and thence compute liveness intervals for arrays. % frees are calculated and thence less fickle
