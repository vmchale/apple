...
% pointer aliasing vs. abstract arrays.
...
The following generates an array and extracts the first element:
...
We can inspect the generated code in the REPL, viz.
...
(movtemp r_15 (int 99))
(movtemp r_13 
  (+ (- (reg r_15) (reg r_14)) (int 1)))
(malloc r_12 : 
  (+ (asl (reg r_13) (int 3)) (int 16)))
